...
IUPAC_CODES_1 = {'A': 1.8, 'C': 2.5, 'D': -3.5, 'E': -3.5, 'F': 2.8, 'G': -0.4, 'H': -3.2, 'I': 4.5, 'K': -3.9, 'L': 3.8,
               'M': 1.9, 'N': -3.5, 'P': -1.6, 'Q': -3.5, 'R': -4.5, 'S': -0.8, 'T': -0.7, 'V': 4.2, 'W': -0.9, 'Y': -1.3, '*': -0.48}

IUPAC_CODES = {'A': 0.0373, 'C': 0.0829, 'D': 0.1263, 'E': 0.0058, 'F': 0.0946, 'G': 0.0050, 'H': 0.0242, 'I': 0, 'K': 0.0371, 'L': 0,
