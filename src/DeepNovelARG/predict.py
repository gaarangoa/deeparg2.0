...
@click.option('--prefix', default="result", help='prefix to output file [default: result ]')
def predict(inputfile, wordvec_model, deeparg_model, deeparg_parameters, outdir, kmer, minp, prefix):
    """
